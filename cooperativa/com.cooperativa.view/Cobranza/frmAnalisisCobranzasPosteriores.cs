...
{
    public partial class frmAnalisisCobranzasPosteriores : Form
    {
        #region << EVENTOS >>
        public frmAnalisisCobranzasPosteriores()
        {
            InitializeComponent();
        }

        private void frmAnalisisCobranzasPosteriores_Load(object sender, EventArgs e)
        {
            Inicializar();
        }
        ...
        private void rbtnTotalidadSyU_CheckedChanged(object sender, EventArgs e)
        {
            OcultaI234();
        }
