...
{
    public partial class frmAnalisisUsuariosSocios : Form
    {


        #region << EVENTOS >>
        public frmAnalisisUsuariosSocios()
        {
            InitializeComponent();
        }

        private void frmAnalisisUsuariosSocios_Load(object sender, EventArgs e)
        {
            Inicializar();
        }
