...
{
    public partial class frmAnalisisEvolucionMensual : Form
    {
        #region << EVENTOS >>

        public frmAnalisisEvolucionMensual()
        {
            InitializeComponent();
        }

        private void frmAnalisisEvolucionMensual_Load(object sender, EventArgs e)
        {
            Inicializar();
        }
        ...
        private void rbtnCobranzaMes_CheckedChanged(object sender, EventArgs e)
        {
            OcultaI234();
        }
