...
{
    public partial class frmSociosEnSituacionEspecial : Form
    {
        public frmSociosEnSituacionEspecial()
        {
            InitializeComponent();
        }

        private void frmSociosEnSituacionEspecial_Load(object sender, EventArgs e)
        {
            Inicializar();
        }
